var FormComponents = function () {
    ...
    var c = function () {
        if ($.fn.inputlimiter) {
            $.extend(true
                ...
                , { boxAttach: false, boxId: "limit-text", remText: "%n character%s remaining.", limitText: "Field limited to %n character%s.", zeroPlural: true })
    ...
    var k = function () {
        if ($.fn.fileInput) {
            $.extend(true
                , $.fn.fileInput.defaults, { placeholder: "No file selected...", buttontext: "Browse..." });
            $('[data-style="fileinput"]').each(function () { var l = $(this); l.fileInput(l.data()) })
        }
    };
    var j = function () {
        if ($.fn.spinner) { $(".spinner").each(function () { $(this).spinner() }) }
    };
    var f = function () {
        if ($.configureBoxes) { $.configureBoxes() }
    };
    var d = function () {
        if ($.validator) {
                ...
                , {
                    ...
                    , showLabel: function (n, o) {
                        ...
                        if (m.length) {
                            ...
                            m.text(""); if (typeof this.settings.success === "string") {
                                m.addClass(this.settings.success)
                            } else { this.settings.success(m, n) }
    ...
    var g = function () {
        if ($.fn.multiselect) { $(".multiselect").each(function () { $(this).multiselect() }) }
    };
    return {
        init: function () {
            a();
