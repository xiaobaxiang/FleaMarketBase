var Plugins = function () {
    ...
    var i = function () {
        if ($.fn.daterangepicker) {
            $(".range").daterangepicker({
                ...
                , endDate: moment(), minDate: "01/01/2012"
                , maxDate: "12/31/2014"
                , dateLimit: { days: 60 }
                , showDropdowns: true
    ...
    var d = function () {
        if ($.noty) { $.extend(true, $.noty.defaults, { type: "alert", timeout: false, maxVisible: 5, animation: { open: { height: "toggle" }, close: { height: "toggle" }, easing: "swing", speed: 200 } }) }
    };
    var c = function () {
        if ($.easyPieChart) {
            $.extend(true
                , $.easyPieChart.defaultOptions
                , { lineCap: "butt", animate: 500, barColor: App.getLayoutColorCode("blue") });
        ...
        if ($.fn.dataTable) {
            $.extend(true
                ...
                , {
                    ...
                    , fnDrawCallback: function () {
                        ...
                        if (o.parent().hasClass("input-group")) { return }
            ...
            $(".datatable").each(function () {
                ...
                if (w.hasClass("table-checkable") && w.hasClass("table-colvis")) {
                    ...
                    var q; var p = { tablet: 1024, phone: 480 };
                    ...
                    $.extend(true
                        ...
                        , {
                            ...
                            , fnPreDrawCallback: function () {
                                if (!q) { q = new ResponsiveDatatablesHelper(this, p) }
                            }
                ...
                if (w.hasClass("table-columnfilter")) {
                    ...
                    if (typeof o != "undefined") { $.extend(true, u, o) }
                ...
                } else { $(this).dataTable(y) }
            })
        }
    };
    var j = {
        colors: [App.getLayoutColorCode("blue")
            , App.getLayoutColorCode("red")
            , App.getLayoutColorCode("green")
            , App.getLayoutColorCode("purple")
            , App.getLayoutColorCode("grey")
            , App.getLayoutColorCode("yellow")]
        , legend: {
            show: true
            , labelBoxBorderColor: ""
        ...
        , series: {
            points: {
                show: false
                , radius: 3, lineWidth: 2, fill: true, fillColor: "#ffffff", symbol: "circle"
            }, lines: {
                show: true
        ...
        , grid: {
            show: true
            , borderColor: "#efefef", tickColor: "rgba(0,0,0,0.06)", labelMargin: 10, axisMargin: 8
            , borderWidth: 0, minBorderMargin: 10, mouseActiveRadius: 5
        }
        , tooltipOpts: { defaultTheme: false }
        , selection: { color: App.getLayoutColorCode("blue") }
    };
    var b = {
        colors: ["#ffffff"], legend: { show: false, backgroundOpacity: 0 }
        , series: { points: {} }, grid: { tickColor: "rgba(255, 255, 255, 0.1)", color: "#ffffff", }, shadowSize: 1
    };
    var f = function () {
        if ($.fn.knob) {
            $(".knob").knob();
            $(".knob").each(function () {
                if (typeof $(this).attr("data-fgColor") == "undefined") {
                    $(this).trigger("configure"
                        , { fgColor: App.getLayoutColorCode("blue"), inputColor: App.getLayoutColorCode("blue") })
                }
            })
        }
    }; var n = {
        type: "bar", height: "19px", zeroAxis: false, barWidth: "4px", barSpacing: "1px"
        , barColor: "#fff"
    }; var e = function () { if ($.fn.colorpicker) { $(".bs-colorpicker").colorpicker() } };
    var a = function () { if ($.fn.template) { $.extend(true, $.fn.template.defaults, {}) } };
    return {
        init:
            function () {
                g();
        ...
        , getFlotDefaults: function () { return j }
        , getFlotWidgetDefaults: function () { return $.extend(true, {}, Plugins.getFlotDefaults(), b) }
        , getSparklineStatboxDefaults: function () { return n }
    }
}();